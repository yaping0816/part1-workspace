...
//        return "Employee: name=" + getName() + ", hireDate=" + getHireDate();
        return String.format("%s: name=%s, hireDate=%s", getClass().getName(),getName(), getHireDate()); //getSimpleName() only return the class name
//        return getClass().getName() + ":name=" + ", hireDate= " + getHireDate();
    }
}